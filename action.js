...
const FILENAME_CONFIRMED = "time_series_covid19_confirmed_global.csv"; //OLD//"time_series_19-covid-Confirmed.csv";
const FILENAME_DEATHS = "time_series_covid19_deaths_global.csv"; //OLD//"time_series_19-covid-Deaths.csv";
const FILENAME_RECOVERED = "time_series_covid19_recovered_global.csv";//OLD//"time_series_19-covid-Recovered.csv";
